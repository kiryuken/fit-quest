  ...
  Future<void> seedDefaultBosses() async {
    ...
    final defaultBosses = [
      BossBattleModel(
        ...
        name: 'Training Dummy',
        description:
            'A sturdy training dummy. Perfect for beginners to test their skills.',
      ...
      BossBattleModel(
        ...
        name: 'Shadow Fighter',
        description:
            'A mysterious fighter who moves like a shadow. Tests agility and speed.',
      ...
      BossBattleModel(
        ...
        name: 'Iron Titan',
        description:
            'A massive golem made of iron. Brute force is needed to crack its armor.',
        level: 10, hp: 400, xpReward: 500,
        requiredWorkouts: 15, tierIndex: 2, difficulty: 3,
        statThresholds: {0: 15, 2: 12}, // STR >= 15, VIT >= 12
      ),
      BossBattleModel(
        id: 'boss_storm_monk',
        name: 'Storm Monk',
      ...
      BossBattleModel(
        ...
        name: 'Dragon Spirit',
        description:
            'The ultimate challenge — a spiritual dragon manifesting pure power.',
        level: 30,
        hp: 2000,
        xpReward: 3000,
        requiredWorkouts: 60,
        tierIndex: 2,
        difficulty: 5,
        statThresholds: {0: 40, 1: 35, 2: 35, 3: 30},
      ),
    ];
